...
class ZenithDescriptionExtractionTests(unittest.TestCase):
    def test_multiline_description_keeps_left_prefix_and_correct_order(self):
        words = [
            ...
            _word("Debit", 620, 655, 100),
            _word("Credit", 700, 742, 100),
            _word("Balance", 790, 842, 100),
            _word("OPENING", 150, 205, 112),
            _word("BALANCE", 210, 260, 112),
            _word("01-Jan-2026", 30, 90, 120),
            _word("01-Jan-2026", 100, 160, 120),
            _word("IKOYI,", 145, 185, 120),
            _word("IKOYI", 190, 225, 120),
            _word("NIP/FCMB/ADEBUTU", 230, 330, 120),
            _word("AJIBOLA", 335, 385, 120),
            _word("BANKOLE", 390, 450, 120),
            _word(".../NIP", 455, 500, 120),
            _word("IFO", 505, 530, 120),
            _word("Gasmart", 535, 585, 120),
            _word("1,000.00", 710, 760, 120),
            _word("1,000.00", 795, 845, 120),
            ...
            _word("500.00", 625, 665, 150),
            _word("500.00", 795, 840, 150),
        ]
