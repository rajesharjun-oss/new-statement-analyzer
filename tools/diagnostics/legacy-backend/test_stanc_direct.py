...
def test_stanc_direct():
    target_dir = Path("c:/Users/ionawoga/Desktop/Statement-analyzer-3.0-1")
    pdf_files = [p for p in target_dir.rglob("*Standard Chartered*") if p.suffix.lower() == ".pdf"]
    
    if not pdf_files:
        print("File not found anywhere in the project!")
        return
